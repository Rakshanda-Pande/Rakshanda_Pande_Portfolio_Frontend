    ...
    return (
        <section id="contact" className="relative py-24 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900">
                ...
                <div className="absolute top-32 right-20 w-1 h-1 bg-blue-400/60 rounded-full animate-ping"></div>
                <div className="absolute bottom-40 left-1/4 w-1.5 h-1.5 bg-purple-400/60 rounded-full animate-pulse delay-300"></div>
                <div className="absolute bottom-20 right-1/3 w-1 h-1 bg-cyan-300/60 rounded-full animate-ping delay-700"></div>
            </div>

            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                {/* Enhanced Header */}
                <div className={`contact-header mb-12 transition-all duration-1000 ${visibleItems.has('header') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                    <div className="flex items-center justify-center mb-4">
                        <Award className="text-cyan-400 mr-3 animate-pulse" size={32} />
                        <h2 className="text-4xl lg:text-4xl p-4 font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent animate-gradient-text">
                            Let's Work Together
                        </h2>
                        <TrendingUp className="text-purple-400 ml-3 animate-pulse" size={32} />
                    </div>
                    <div className="w-40 h-1 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 mx-auto rounded-full animate-pulse"></div>
                    <p className="mt-6 text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                ...
                <div className={`contact-content relative transform transition-all duration-1000 ${visibleItems.has('content') ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-8 opacity-0 scale-95'}`}>
                    ...
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-400/30 via-blue-500/30 to-purple-600/30 rounded-3xl opacity-75 blur-sm animate-pulse"></div>
                    
                    <div className="relative bg-slate-800/90 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-slate-700/50">
                        {/* Enhanced Content */}
                        <div className="mb-8">
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-400/10 border border-cyan-400/20 rounded-full mb-6 backdrop-blur-sm">
                                <Sparkles className="w-4 h-4 text-cyan-400" />
                                <span className="text-cyan-400 text-sm font-medium">Get In Touch</span>
                            </div>
                            
                            <h3 className="text-3xl font-bold mb-6 text-white">Ready to bring your ideas to life?</h3>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-10">
                            <div className="bg-slate-700/50 rounded-2xl p-6 border border-slate-600/50 hover:border-cyan-400/50 transition-all duration-300 group">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-gray-400 text-sm">rakshandapande2107@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-700/50 rounded-2xl p-6 border border-slate-600/50 hover:border-cyan-400/50 transition-all duration-300 group">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-gray-400 text-sm">Anywhere in the World</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex justify-center space-x-6">
                                {socialLinks.map((social, index) => (
                                    <a
                                        ...
                                        className={`group relative p-4 bg-gradient-to-r ${hoveredSocial === index ? social.hoverColor : social.color} rounded-2xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-2xl`}
                                    ...
                                    >
                                        ...
                                        {/* Tooltip */}
                                        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-slate-800 text-white px-3 py-1 rounded-lg text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                                            {social.name}
                        ...
                        <div className="mt-10">
                            ...
                            <button 
                                ...
                                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-10 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25"
                            >
            ...
            {showForm && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
                    <div className="bg-slate-800 rounded-3xl border border-slate-700 w-full max-w-md transform transition-all duration-300 scale-100 animate-modal-in shadow-2xl">
                            ...
                            <div className="p-6 space-y-4">
                                <div className="animate-slide-in-up" style={{ animationDelay: '0.1s' }}>
                                    <input 
                                        ...
                                        className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-xl focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-all text-white placeholder-gray-400" 
                                    />
                                </div>
                                ...
                                <div className="animate-slide-in-up" style={{ animationDelay: '0.4s' }}>
                                    <textarea 
                                        ...
                                        onChange={handleInputChange} 
                                        rows={4} 
                                        className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-xl focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-all resize-none text-white placeholder-gray-400" 
                                    />
                                </div>
                                ...
                                <button 
                                    ...
                                    className={`w-full py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 animate-slide-in-up ${
